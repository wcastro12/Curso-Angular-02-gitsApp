// To parse this data:
//
//   import { Convert, SearchGifsRespont } from "./file";
//
//   const searchGifsRespont = Convert.toSearchGifsRespont(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SearchGifsRespont {
    data:       Gif[];
...
export class Convert {
    public static toSearchGifsRespont(json: string): SearchGifsRespont {
        return cast(JSON.parse(json), r("SearchGifsRespont"));
    }

    public static searchGifsRespontToJson(value: SearchGifsRespont): string {
        return JSON.stringify(uncast(value, r("SearchGifsRespont")), null, 2);
    }
}
